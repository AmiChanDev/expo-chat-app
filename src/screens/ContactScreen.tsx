            ...
            >
                ...
                <View className="px-8 pb-8">
                    <Pressable
                        ...
                        onPress={() => {
                            const validCountryCode = Validation.validateCountryCode(countryCode);
                            const validContactNo = Validation.validatePhoneNo(contactNo);

                            if (!validCountryCode) {
                                Toast.show({
                                    type: ALERT_TYPE.DANGER,
                                    title: "Invalid Country",
                                    textBody: "Please select a valid country",
                                });
